...
//                                 <div class="fw-bold">${product.name || 'Unnamed Product'}</div>
//                                 <small class="text-muted">${product.type || 'Unknown'} - $${product.price || 'N/A'}</small>
//                             </div>
//                             <button class="btn btn-sm btn-primary view-product" data-id="${product.id || ''}">
//                                 View
//                             </button>
//                         `;
